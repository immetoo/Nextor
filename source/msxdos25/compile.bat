...
copy ..\bank0\b0labels.inc
for %%A in (B4,JUMP,ENV,CPM,BKALLOC,PARTIT,RAMDRV,MISC) do cpm32 M80 =%%A
cpm32 L80 /P:40FF,CODES,KVAR,DATA,B4,JUMP,ENV,CPM,BKALLOC,PARTIT,RAMDRV,MISC,/p:7fd0,chgbnk,B4/N/X/Y/E
...
copy dos250ba.dat Nextor-2.0.4.base.dat
copy dos250ba.dat ..\..\bin\kernels\Nextor-2.0.4.base.dat
